...
return(
        ...
        <div class="container">
            <div class="row">
                <div style={{marginBottom: "50px"}} class="col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <li style={{ color:'black',marginBottom:'100px'}} class="list-group-item list-group-item-action list-group-item-primary mb-2" >
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button onClick={
                                                ...
                                                }} id={comprobante.id} class="btn btn-danger" type="button">Borrar</button>
                                            <button class="btn btn-warning" type="button" onClick={(e) => put(e)} id={comprobante.id}>Modificar</button>
                                        </div>
                                    </li>   
                                )
                            })
