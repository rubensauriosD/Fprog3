...
return(
    ...
    // <div style={{width:'1000px', marginLeft:'500px', marginTop:'50px', marginB}}>
                ...
                <div style={{marginBottom: "50px"}} class="col-sm-12 col-md-5 col-lg-5">
                    ...
                    <form class=""  onSubmit={(e)=> post(e)}>
                        ...
                        <div class="mb-3">
                            ...
                            <input onChange={(e) => handleChange(e)} name='nombre' value={inputs.nombre} type="text" class="form-control form-control-lg" id="autoSizingInput" placeholder="Nombre"></input>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="visually-hidden" for="autoSizingInput"></label>
                            <input onChange={(e) => handleChange(e)} name='codigo' value={inputs.codigo} type="number" class="form-control form-control-lg" id="autoSizingInput" placeholder="Codigo"></input>
                        </div>
                        <div class="mb-3">
                            <label class="visually-hidden" for="autoSizingInput"></label>
                            <input onChange={(e) => handleChange(e)} name='stock' value={inputs.stock} type="number" class="form-control form-control-lg" id="autoSizingInput" placeholder="Stock"></input>
                        </div>
                        <div class="mb-3">
                            <label class="visually-hidden" for="autoSizingInput"></label>
                            <input onChange={(e) => handleChange(e)} name='precio_costo' value={inputs.precio_costo} type="number" class="form-control form-control-lg" id="autoSizingInput" placeholder="Precio de Costo"></input>
                        </div>
                        <div class="mb-3">
                            <label class="visually-hidden" for="autoSizingInput"></label>
                            <input onChange={(e) => handleChange(e)} name='precio_venta' value={inputs.precio_venta} type="number" class="form-control form-control-lg" id="autoSizingInput" placeholder="Precio de Venta"></input>
                        </div>
                        <div class="mb-3">
                            <label class="visually-hidden" for="autoSizingInput"></label>
                            <input onChange={(e) => handleChange(e)} name='stock_minimo' value={inputs.stock_minimo} type="number" class="form-control form-control-lg" id="autoSizingInput" placeholder="Stock Minimo"></input>
                        </div>
                        <div class="mb-2">
                    ...
                    <ul class="list-group">  
                    {
                        articulos.map(articulo => {
                            return(
                                ...
                                <button style={{ marginRight:'50px', marginTop:'20px',marginBottom:'10px'}} type="button" class="btn btn-danger" onClick={(e) => delet(e)} id={articulo.id}>Borrar</button>
                                <button style={{ marginLeft:'50px', marginTop:'20px',marginBottom:'10px'}} type="button" class="btn btn-warning" onClick={(e) => put(e)} id={articulo.id}>Modificar</button>
                                </li>   
                            )
                        })
                    }
